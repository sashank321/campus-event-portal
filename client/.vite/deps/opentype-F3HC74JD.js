...
pe.prototype.addBezier = function(e, r, t, a, n, s, i, u) {
  ...
  for (var p = 0; p <= 1; p++) {
    ...
    if (!(y < 0)) {
      ...
      var b = (-c - Math.sqrt(y)) / (2 * d);
      0 < b && b < 1 && (p === 0 && this.addX(Te(o[p], l[p], f[p], h[p], b)), p === 1 && this.addY(Te(o[p], l[p], f[p], h[p], b)));
    }
  }
};
...
var S = { Table: z, Record: z, Coverage: Ye, ScriptList: Ze, FeatureList: Qe, LookupList: Ke, ushortList: Re, tableList: dr, recordList: we };
function Hr(e, r) {
  return e.getUint8(r);
}
function Je(e, r) {
...
function _r(e, r, t) {
  ...
  if (e.isCIDFont) {
    var C = e.tables.cff.topDict._fdSelect[r.index], b = e.tables.cff.topDict._fdArray[C];
    d = b._subrs, x = b._subrsBias, m = b._defaultWidthX, y = b._nominalWidthX;
...
function sn(e, r, t, a) {
  ...
  var b;
  a.lowMemory ? (b = Qa(e, r + f.charStrings), t.nGlyphs = b.offsets.length) : (b = ve(e, r + f.charStrings), t.nGlyphs = b.objects.length);
  ...
  if (f.encoding === 0 ? t.cffEncoding = new je(Na, R) : f.encoding === 1 ? t.cffEncoding = new je(Ha, R) : t.cffEncoding = an(e, r + f.encoding, R), t.encoding = t.encoding || t.cffEncoding, t.glyphs = new ue.GlyphSet(t), a.lowMemory) t._push = function(L) {
    var F = Ka(L, b.offsets, e, r + f.charStrings);
...
function on() {
  return new S.Record("Header", [{ name: "major", type: "Card8", value: 1 }, { name: "minor", type: "Card8", value: 0 }, { name: "hdrSize", type: "Card8", value: 4 }, { name: "major", type: "Card8", value: 1 }]);
}
function un(e) {
  var r = new S.Record("Name INDEX", [{ name: "names", type: "INDEX", value: [] }]);
  r.names = [];
...
function Vr(e, r) {
  var t = new S.Record("Top DICT", [{ name: "dict", type: "DICT", value: {} }]);
  return t.dict = Pt(At, e, r), t;
}
function qr(e) {
  var r = new S.Record("Top DICT INDEX", [{ name: "topDicts", type: "INDEX", value: [] }]);
  return r.topDicts = [{ name: "topDict_0", type: "TABLE", value: e }], r;
}
function ln(e) {
  var r = new S.Record("String INDEX", [{ name: "strings", type: "INDEX", value: [] }]);
  r.strings = [];
  for (var t = 0; t < e.length; t += 1) r.strings.push({ name: "string_" + t, type: "STRING", value: e[t] });
  return r;
}
function fn() {
  return new S.Record("Global Subr INDEX", [{ name: "subrs", type: "INDEX", value: [] }]);
}
function pn(e, r) {
  for (var t = new S.Record("Charsets", [{ name: "format", type: "Card8", value: 0 }]), a = 0; a < e.length; a += 1) {
    var n = e[a], s = Mt(n, r);
...
function cn(e) {
  for (var r = new S.Record("CharStrings INDEX", [{ name: "charStrings", type: "INDEX", value: [] }]), t = 0; t < e.length; t += 1) {
...
function kn(e) {
  for (var r = new S.Table("hmtx", []), t = 0; t < e.length; t += 1) {
...
function Fn(e) {
  for (var r = new S.Table("ltag", [{ name: "version", type: "ULONG", value: 1 }, { name: "flags", type: "ULONG", value: 0 }, { name: "numTags", type: "ULONG", value: e.length }]), t = "", a = 12 + e.length * 4, n = 0; n < e.length; ++n) {
    var s = t.indexOf(e[n]);
...
function En(e) {
  return new S.Table("maxp", [{ name: "version", type: "FIXED", value: 20480 }, { name: "numGlyphs", type: "USHORT", value: e }]);
}
...
function Xr(e, r, t, a, n, s) {
  return new S.Record("NameRecord", [{ name: "platformID", type: "USHORT", value: e }, { name: "encodingID", type: "USHORT", value: r }, { name: "languageID", type: "USHORT", value: t }, { name: "nameID", type: "USHORT", value: a }, { name: "length", type: "USHORT", value: n }, { name: "offset", type: "USHORT", value: s }]);
}
function An(e, r) {
...
function Bn(e, r) {
  ...
  for (var o = nr(qt), l = nr(Xt), f = [], h = [], p = 0; p < a.length; p++) {
    ...
    var c = n[t];
    for (var d in c) {
      var x = c[d], m = 1, y = o[d], C = On[y], b = Yt(m, C, y), R = g.MACSTRING(x, b);
  ...
  for (var G = new S.Table("name", [{ name: "format", type: "USHORT", value: 0 }, { name: "count", type: "USHORT", value: f.length }, { name: "stringOffset", type: "USHORT", value: 6 + f.length * 12 }]), Y = 0; Y < f.length; Y++) G.fields.push({ name: "record_" + Y, type: "RECORD", value: f[Y] });
...
var Ue = new Array(9);
Ue[1] = function(r) {
  return r.substFormat === 1 ? new S.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new S.Coverage(r.coverage) }, { name: "deltaGlyphID", type: "USHORT", value: r.deltaGlyphId }]) : new S.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 2 }, { name: "coverage", type: "TABLE", value: new S.Coverage(r.coverage) }].concat(S.ushortList("substitute", r.substitute)));
};
Ue[2] = function(r) {
  return U.assert(r.substFormat === 1, "Lookup type 2 substFormat must be 1."), new S.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new S.Coverage(r.coverage) }].concat(S.tableList("seqSet", r.sequences, function(t) {
    return new S.Table("sequenceSetTable", S.ushortList("sequence", t));
  })));
};
Ue[3] = function(r) {
  return U.assert(r.substFormat === 1, "Lookup type 3 substFormat must be 1."), new S.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new S.Coverage(r.coverage) }].concat(S.tableList("altSet", r.alternateSets, function(t) {
    return new S.Table("alternateSetTable", S.ushortList("alternate", t));
  })));
};
Ue[4] = function(r) {
  return U.assert(r.substFormat === 1, "Lookup type 4 substFormat must be 1."), new S.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new S.Coverage(r.coverage) }].concat(S.tableList("ligSet", r.ligatureSets, function(t) {
    return new S.Table("ligatureSetTable", S.tableList("ligature", t, function(a) {
      return new S.Table("ligatureTable", [{ name: "ligGlyph", type: "USHORT", value: a.ligGlyph }].concat(S.ushortList("component", a.components, a.components.length + 1)));
    }));
  })));
};
Ue[6] = function(r) {
  if (r.substFormat === 1) {
    var t = new S.Table("chainContextTable", [{ name: "substFormat", type: "USHORT", value: r.substFormat }, { name: "coverage", type: "TABLE", value: new S.Coverage(r.coverage) }].concat(S.tableList("chainRuleSet", r.chainRuleSets, function(s) {
      return new S.Table("chainRuleSetTable", S.tableList("chainRule", s, function(i) {
        var u = S.ushortList("backtrackGlyph", i.backtrack, i.backtrack.length).concat(S.ushortList("inputGlyph", i.input, i.input.length + 1)).concat(S.ushortList("lookaheadGlyph", i.lookahead, i.lookahead.length)).concat(S.ushortList("substitution", [], i.lookupRecords.length));
    ...
    var n = new S.Table("chainContextTable", a);
    return n;
  }
  U.assert(false, "lookup type 6 format must be 1, 2 or 3.");
};
function zn(e) {
  return new S.Table("GSUB", [{ name: "version", type: "ULONG", value: 65536 }, { name: "scripts", type: "TABLE", value: new S.ScriptList(e.scripts) }, { name: "features", type: "TABLE", value: new S.FeatureList(e.features) }, { name: "lookups", type: "TABLE", value: new S.LookupList(e.lookups, Ue) }]);
}
...
function _n(e) {
  var r = Object.keys(e).length, t = "", a = 16 + r * 12, n = new S.Table("meta", [{ name: "version", type: "ULONG", value: 1 }, { name: "flags", type: "ULONG", value: 0 }, { name: "offset", type: "ULONG", value: a }, { name: "numTags", type: "ULONG", value: r }]);
  for (var s in e) {
    var i = t.length;
...
function Qr(e, r, t, a) {
  return new S.Record("Table Record", [{ name: "tag", type: "TAG", value: e !== void 0 ? e : "" }, { name: "checkSum", type: "ULONG", value: r !== void 0 ? r : 0 }, { name: "offset", type: "ULONG", value: t !== void 0 ? t : 0 }, { name: "length", type: "ULONG", value: a !== void 0 ? a : 0 }]);
}
function jt(e) {
  var r = new S.Table("sfnt", [{ name: "version", type: "TAG", value: "OTTO" }, { name: "numTables", type: "USHORT", value: 0 }, { name: "searchRange", type: "USHORT", value: 0 }, { name: "entrySelector", type: "USHORT", value: 0 }, { name: "rangeShift", type: "USHORT", value: 0 }]);
...
function qn(e) {
  ...
  var b = { xMin: Math.min.apply(null, r), yMin: Math.min.apply(null, t), xMax: Math.max.apply(null, a), yMax: Math.max.apply(null, n), advanceWidthMax: Math.max.apply(null, s), advanceWidthAvg: Vn(s), minLeftSideBearing: Math.min.apply(null, i), maxLeftSideBearing: Math.max.apply(null, i), minRightSideBearing: Math.min.apply(null, u) };
  b.ascender = e.ascender, b.descender = e.descender;
  var R = Nt.make({ flags: 3, unitsPerEm: e.unitsPerEm, xMin: b.xMin, yMin: b.yMin, xMax: b.xMax, yMax: b.yMax, lowestRecPPEM: 3, createdTimestamp: e.createdTimestamp }), O = Ht.make({ ascender: b.ascender, descender: b.descender, advanceWidthMax: b.advanceWidthMax, minLeftSideBearing: b.minLeftSideBearing, minRightSideBearing: b.minRightSideBearing, xMaxExtent: b.maxLeftSideBearing + (b.xMax - b.xMin), numberOfHMetrics: e.glyphs.length }), D = _t.make(e.glyphs.length), L = xr.make(Object.assign({ xAvgCharWidth: Math.round(b.advanceWidthAvg), usFirstCharIndex: o, usLastCharIndex: l, ulUnicodeRange1: f, ulUnicodeRange2: h, ulUnicodeRange3: p, ulUnicodeRange4: c, sTypoAscender: b.ascender, sTypoDescender: b.descender, sTypoLineGap: 0, usWinAscent: b.yMax, usWinDescent: Math.abs(b.yMin), ulCodePageRange1: 1, sxHeight: Kr(e, "xyvw", { yMax: Math.round(b.ascender / 2) }).yMax, sCapHeight: Kr(e, "HIKLEFJMNTZBDPRAGOQSUVWXY", b).yMax, usDefaultChar: e.hasChar(" ") ? 32 : 0, usBreakChar: e.hasChar(" ") ? 32 : 0 }, e.tables.os2)), F = zt.make(e.glyphs), G = Et.make(e.glyphs), Y = e.getEnglishName("fontFamily"), Z = e.getEnglishName("fontSubfamily"), j = Y + " " + Z, $ = e.getEnglishName("postScriptName");
  $ || ($ = Y.replace(/\s/g, "") + "-" + Z);
  var M = {};
  ...
  var W = [], _ = Zt.make(M, W), V = W.length > 0 ? Wt.make(W) : void 0, H = Qt.make(), X = Gt.make(e.glyphs, { version: e.getEnglishName("version"), fullName: j, familyName: Y, weightName: Z, postScriptName: $, unitsPerEm: e.unitsPerEm, fontBBox: [0, b.yMin, b.ascender, b.advanceWidthMax] }), A = e.metas && Object.keys(e.metas).length > 0 ? Jt.make(e.metas) : void 0, q = [R, O, D, L, _, G, H, X, F];
  ...
  if (e.numberOfContours > 0) {
    ...
    if (U.argument(n.length === l, "Bad flags."), i.length > 0) {
      ...
      if (l > 0) {
        ...
        for (var C = 0, b = 0; b < l; b += 1) s = n[b], d = c[b], d.y = $r(a, s, C, 4, 32), C = d.y;
      }
      e.points = c;
    } else e.points = [];
...
sa = function(e, r) {
  ...
  if (de.prototype = r, !n) u = new de("glyf", e.instructions), exports.DEBUG && (console.log("---EXEC GLYPH---"), u.step = -1), br(e, u, t, a), i = u.gZone;
    ...
    for (var l = 0; l < n.length; l++) {
      ...
      var C = i.length;
      i.push.apply(i, d);
      for (var b = 0; b < x.length; b++) s.push(x[b] + C);
    }
...
function ps(e) {
  ...
  var d = l.x, x = l.y, m = f.x, y = f.y, C = h.x, b = h.y, R = p.x, O = p.y, D = (d - m) * (b - O) - (x - y) * (C - R), L = d * y - x * m, F = C * O - b * R;
  c.x = (L * (C - R) - F * (d - m)) / D, c.y = (L * (b - O) - F * (x - y)) / D;
}
function hs(e) {
...
function Bi(e, r) {
  ...
  if (h) for (var c = 0; c < r.lookupRecords.length; c++) for (var d = r.lookupRecords[c], x = d.lookupListIndex, m = this.getLookupByIndex(x), y = 0; y < m.subtables.length; y++) {
    var C = m.subtables[y], b = this.getLookupMethod(m, C);
    if (!!b) {
      var R = this.getSubstitutionType(m, C);
...
J.prototype.getSubstitutionType = function(e, r) {
  if (e.lookupType === 7 && r && r.extension) return r.lookupType.toString() + r.extension.substFormat.toString();
  var t = e.lookupType.toString(), a = r.substFormat.toString();
  return t + a;
};
J.prototype.getLookupMethod = function(e, r) {
  var t = this;
  if (e.lookupType === 7 && r && r.extension) return this.getLookupMethod({ lookupType: r.lookupType }, r.extension);
  var a = this.getSubstitutionType(e, r);
  switch (a) {
    case "11":
      return function(n) {
...
J.prototype.lookupFeature = function(e) {
  ...
  for (var n = this.getFeatureLookups(a), s = [].concat(r.context), i = 0; i < n.length; i++) for (var u = n[i], o = this.getLookupSubtables(u), l = 0; l < o.length; l++) {
    var f = o[l], h = this.getSubstitutionType(u, f), p = this.getLookupMethod(u, f);
    if (!!p) {
      var c = void 0;
      switch (h) {
        case "11":
...
var To = new Array(10);
function ko(e) {
  return new S.Table("GPOS", [{ name: "version", type: "ULONG", value: 65536 }, { name: "scripts", type: "TABLE", value: new S.ScriptList(e.scripts) }, { name: "features", type: "TABLE", value: new S.FeatureList(e.features) }, { name: "lookups", type: "TABLE", value: new S.LookupList(e.lookups, To) }]);
}
...
function Dr(e, r) {
  ...
  for (var f, h, p, c, d, x, m, y, C, b, R, O, D = 0; D < i; D += 1) {
    var L = u[D], F = void 0;
    switch (L.tag) {
      case "cmap":
...
//# sourceMappingURL=opentype-F3HC74JD.js.map
