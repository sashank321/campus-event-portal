...
async function Module(moduleArg = {}) {
  ...
  function updateMemoryViews() {
    var _a;
    if ((_a = HEAP8 == null ? void 0 : HEAP8.buffer) == null ? void 0 : _a.resizable) return;
  ...
  var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, filesystems: null, syncFSRequests: 0, ErrnoError: class {
    ...
    (_a = stream.node) == null ? void 0 : _a.notifyListeners(32);
    try {
  ...
  function assignWasmExports(wasmExports2) {
    ...
    _malloc = Module2["_malloc"] = wasmExports2["G"];
    _free = Module2["_free"] = wasmExports2["H"];
    __emscripten_timeout = wasmExports2["I"];
  ...
  var wasmImports = { e: ___cxa_throw, w: __abort_js, g: __embind_finalize_value_array, j: __embind_register_bigint, n: __embind_register_bool, l: __embind_register_emval, B: __embind_register_enum, h: __embind_register_enum_value, i: __embind_register_float, a: __embind_register_function, d: __embind_register_integer, c: __embind_register_memory_view, m: __embind_register_std_string, f: __embind_register_std_wstring, k: __embind_register_value_array, b: __embind_register_value_array_element, o: __embind_register_void, v: __emscripten_runtime_keepalive_clear, p: __setitimer_js, q: __tzset_js, r: _emscripten_resize_heap, s: _environ_get, t: _environ_sizes_get, y: _fd_close, A: _fd_read, x: _fd_seek, z: _fd_write, u: _proc_exit };
  async function run() {
    var _a;
    preRun();
    if (runDependencies) {
...
//# sourceMappingURL=process-6Z5VCIIU.js.map
